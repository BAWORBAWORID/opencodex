export const installCommand = 'npm install -g @opencodex/opencodex'
...
export const navLinks = [
  ...
  { href: 'https://github.com/Opencodex/opencodex', label: 'github' },
  { href: 'https://gitlawb.com/node/repos/z6MkqDnb/opencodex', label: 'gitlawb' },
] as const
