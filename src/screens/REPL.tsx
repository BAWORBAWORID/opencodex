...
export function REPL({
  ...
  const terminalTitle = sessionTitle ?? agentTitle ?? haikuTitle ?? 'OpenCodex';
  ...
  useEffect(() => {
    const handleSuspend = () => {
      ...
      process.stdout.write(`\nOpenCodex has been suspended. Run \`fg\` to bring OpenCodex back.\nNote: ctrl + z now suspends OpenCodex, ctrl + _ undoes input.\n`);
    };
    const handleResume = () => {
