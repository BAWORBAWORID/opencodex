...
export function createWhatsNewFeed(releaseNotes: string[]): FeedConfig {
  ...
  return {
    title: "external" === 'ant' ? "OpenCodex Updates [internal-only: Latest CC commits]" : "OpenCodex Updates",
    lines,
...
export function createGuestPassesFeed(): FeedConfig {
  ...
  const subtitle = reward ? `Share OpenCodex and earn ${formatCreditAmount(reward)} of extra usage` : 'Share OpenCodex with friends';
  return {
