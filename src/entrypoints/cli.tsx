...
// OpenCodex: polyfill globalThis.File for Node < 20.
...
// OpenCodex: disable experimental API betas by default.
...
// Closes: Opencodex/opencodex#402 — JavaScript heap OOM during large tasks.
...
async function main(): Promise<void> {
  ...
  if (args.length === 1 && (args[0] === '--version' || args[0] === '-v' || args[0] === '-V')) {
    ...
    console.log(`${MACRO.DISPLAY_VERSION ?? MACRO.VERSION} (OpenCodex)`);
    return;
  }
