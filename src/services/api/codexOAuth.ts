...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to OpenCodex now.</p>
    <p>OpenCodex will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in OpenCodex.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in OpenCodex.</p>
  </body>
</html>`
}
